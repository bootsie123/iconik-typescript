...
export class TranscoderReadSchema {
    'id'?: string;
    'name': string;
    'settings': any;
    'type': TranscoderReadSchemaTypeEnum;
    ...
    static getAttributeTypeMap() {
        return TranscoderReadSchema.attributeTypeMap;
    }
...
export enum TranscoderReadSchemaTypeEnum {
    Vantage = 'VANTAGE',
    Ffmpeg = 'FFMPEG',
