...
export class CollectionElastic {
    'category'?: string | null;
    'createdByUser'?: string;
    'customKeyframe'?: string | null;
    'customOrderStatus'?: CollectionElasticCustomOrderStatusEnum;
    ...
    'position'?: number;
    'status'?: CollectionElasticStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CollectionElasticCustomOrderStatusEnum",
            "format": ""
        },
        {
            "name": "customPoster",
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "CollectionElasticStatusEnum",
            "format": ""
        },
        {
            "name": "storageId",
    ...
    static getAttributeTypeMap() {
        return CollectionElastic.attributeTypeMap;
    }
...
export enum CollectionElasticCustomOrderStatusEnum {
    Disabled = 'DISABLED',
    Enabling = 'ENABLING',
    Enabled = 'ENABLED'
}
export enum CollectionElasticStatusEnum {
    Active = 'ACTIVE',
    Hidden = 'HIDDEN',
    Deleted = 'DELETED'
}
