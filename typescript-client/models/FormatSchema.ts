...
export class FormatSchema {
    'archiveStatus'?: FormatSchemaArchiveStatusEnum;
    'assetId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "FormatSchemaArchiveStatusEnum",
            "format": ""
        },
        {
            "name": "assetId",
...
export enum FormatSchemaArchiveStatusEnum {
    NotArchived = 'NOT_ARCHIVED',
    Archiving = 'ARCHIVING',
    FailedToArchive = 'FAILED_TO_ARCHIVE',
    Archived = 'ARCHIVED'
}
export enum FormatSchemaStatusEnum {
    Active = 'ACTIVE',
    Deleted = 'DELETED'
}
