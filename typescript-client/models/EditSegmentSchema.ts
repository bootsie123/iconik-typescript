...
export class EditSegmentSchema {
    'assetId'?: string;
    'dateCreated'?: Date;
    'dateModified'?: Date;
    ...
    'segmentType': EditSegmentSchemaSegmentTypeEnum;
    'shareUserEmail'?: string | null;
    'status'?: EditSegmentSchemaStatusEnum;
    'subclipId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "EditSegmentSchemaSegmentTypeEnum",
            "format": ""
        },
        {
            "name": "shareUserEmail",
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "EditSegmentSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "subclipId",
    ...
    static getAttributeTypeMap() {
        return EditSegmentSchema.attributeTypeMap;
    }
...
export enum EditSegmentSchemaSegmentTypeEnum {
    Marker = 'MARKER',
    Qc = 'QC',
    Generic = 'GENERIC',
    Comment = 'COMMENT',
...
export enum EditSegmentSchemaStatusEnum {
    Active = 'ACTIVE',
    Deleted = 'DELETED'
}
