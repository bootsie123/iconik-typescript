...
export class AssetSchema {
    'analyzeStatus'?: AssetSchemaAnalyzeStatusEnum;
    'archiveStatus'?: AssetSchemaArchiveStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "AssetSchemaAnalyzeStatusEnum",
            "format": ""
        },
        {
            "name": "archiveStatus",
            "baseName": "archive_status",
            "type": "AssetSchemaArchiveStatusEnum",
            "format": ""
        },
        {
            "name": "category",
    ...
    static getAttributeTypeMap() {
        return AssetSchema.attributeTypeMap;
    }
...
export enum AssetSchemaAnalyzeStatusEnum {
    NA = 'N/A',
    Requested = 'REQUESTED',
...
export enum AssetSchemaArchiveStatusEnum {
    NotArchived = 'NOT_ARCHIVED',
    Archiving = 'ARCHIVING',
    FailedToArchive = 'FAILED_TO_ARCHIVE',
    Archived = 'ARCHIVED'
}
export enum AssetSchemaStatusEnum {
    Active = 'ACTIVE',
    Deleted = 'DELETED'
}
export enum AssetSchemaTypeEnum {
    Asset = 'ASSET',
    Sequence = 'SEQUENCE',
