...
export class JobCreateSchema {
    ...
    'startedAt'?: Date;
    'status': JobCreateSchemaStatusEnum;
    'steps'?: Array<JobStep>;
    'title': string;
    'type': JobCreateSchemaTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "JobCreateSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "steps",
    ...
    static getAttributeTypeMap() {
        return JobCreateSchema.attributeTypeMap;
    }
...
export enum JobCreateSchemaStatusEnum {
    Ready = 'READY',
    Started = 'STARTED',
    Finished = 'FINISHED',
...
export enum JobCreateSchemaTypeEnum {
    Mediainfo = 'MEDIAINFO',
    Transcode = 'TRANSCODE',
    Keyframes = 'KEYFRAMES',
    Export = 'EXPORT',
