...
export class SegmentSchema {
    ...
    'segmentType': SegmentSchemaSegmentTypeEnum;
    'shareUserEmail'?: string | null;
    'status'?: SegmentSchemaStatusEnum;
    'subclipId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "SegmentSchemaSegmentTypeEnum",
            "format": ""
        },
        {
            "name": "shareUserEmail",
    ...
    static getAttributeTypeMap() {
        return SegmentSchema.attributeTypeMap;
    }
...
export enum SegmentSchemaSegmentTypeEnum {
    Marker = 'MARKER',
    Qc = 'QC',
    Generic = 'GENERIC',
    Comment = 'COMMENT',
...
export enum SegmentSchemaStatusEnum {
    Active = 'ACTIVE',
    Deleted = 'DELETED'
}
