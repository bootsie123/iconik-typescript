...
export class SystemNotificationSchema {
    'context'?: any;
    'dateCreated'?: Date;
    'dateModified'?: Date;
    'eventType': string;
    ...
    'shareId'?: string;
    'shareUserId'?: string;
    'status'?: SystemNotificationSchemaStatusEnum | null;
    'subObjectId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "SystemNotificationSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "subObjectId",
    ...
    static getAttributeTypeMap() {
        return SystemNotificationSchema.attributeTypeMap;
    }
...
export enum SystemNotificationSchemaStatusEnum {
    Queued = 'QUEUED',
    Sent = 'SENT',
    Read = 'READ'
}
