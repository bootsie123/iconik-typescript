...
export class KeyframeSchema {
    ...
    'size'?: number | null;
    'status'?: KeyframeSchemaStatusEnum;
    'storageId': string;
    'storageMethod'?: string;
    'timeCode'?: TimeCodeType;
    'type': KeyframeSchemaTypeEnum;
    ...
    static getAttributeTypeMap() {
        return KeyframeSchema.attributeTypeMap;
    }
...
export enum KeyframeSchemaStatusEnum {
    Open = 'OPEN',
    Growing = 'GROWING',
    Awaited = 'AWAITED',
    Closed = 'CLOSED',
...
export enum KeyframeSchemaTypeEnum {
