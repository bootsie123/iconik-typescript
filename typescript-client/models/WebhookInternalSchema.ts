...
export class WebhookInternalSchema {
    'description'?: string;
    /**
    ...
    */
    ...
    'status': WebhookInternalSchemaStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "WebhookInternalSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "objectId",
    ...
    static getAttributeTypeMap() {
        return WebhookInternalSchema.attributeTypeMap;
    }
...
export enum WebhookInternalSchemaStatusEnum {
    Enabled = 'ENABLED',
    Disabled = 'DISABLED',
    Failing = 'FAILING',
    Deleted = 'DELETED'
