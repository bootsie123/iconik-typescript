...
export class JobBaseSchema {
    ...
    'startedAt'?: Date;
    'status': JobBaseSchemaStatusEnum;
    'title': string;
    'type': JobBaseSchemaTypeEnum;
    ...
    static getAttributeTypeMap() {
        return JobBaseSchema.attributeTypeMap;
    }
...
export enum JobBaseSchemaStatusEnum {
    Ready = 'READY',
    Started = 'STARTED',
    Finished = 'FINISHED',
...
export enum JobBaseSchemaTypeEnum {
    Mediainfo = 'MEDIAINFO',
    Transcode = 'TRANSCODE',
    Keyframes = 'KEYFRAMES',
    Export = 'EXPORT',
