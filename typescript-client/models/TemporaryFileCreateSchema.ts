...
export class TemporaryFileCreateSchema {
    'assetId'?: string;
    ...
    */
    ...
    'pathExist'?: boolean;
    'size'?: number;
    'status'?: TemporaryFileCreateSchemaStatusEnum;
    'storageId'?: string;
    'storageMethod'?: string;
    'type': TemporaryFileCreateSchemaTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "TemporaryFileCreateSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "storageId",
    ...
    static getAttributeTypeMap() {
        return TemporaryFileCreateSchema.attributeTypeMap;
    }
...
export enum TemporaryFileCreateSchemaStatusEnum {
    Open = 'OPEN',
    Growing = 'GROWING',
    Awaited = 'AWAITED',
    Closed = 'CLOSED',
...
export enum TemporaryFileCreateSchemaTypeEnum {
    File = 'FILE',
    Directory = 'DIRECTORY',
    Symlink = 'SYMLINK'
}
