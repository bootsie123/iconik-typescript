...
export class JobElasticSchema {
    ...
    'startedAt'?: Date;
    'status': JobElasticSchemaStatusEnum;
    'steps'?: Array<JobStepElastic>;
    'storageId'?: string;
    'title': string;
    'type': JobElasticSchemaTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "JobElasticSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "steps",
            "baseName": "steps",
            "type": "Array<JobStepElastic>",
            "format": ""
        },
        {
            "name": "storageId",
    ...
    static getAttributeTypeMap() {
        return JobElasticSchema.attributeTypeMap;
    }
...
export enum JobElasticSchemaStatusEnum {
    Ready = 'READY',
    Started = 'STARTED',
    Finished = 'FINISHED',
...
export enum JobElasticSchemaTypeEnum {
    Mediainfo = 'MEDIAINFO',
    Transcode = 'TRANSCODE',
    Keyframes = 'KEYFRAMES',
    Export = 'EXPORT',
