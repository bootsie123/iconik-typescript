...
export class ProxyCreateSchema {
    'assetId'?: string;
    'audioBitrate'?: number;
    'bitRate'?: number;
    'codec'?: string;
    ...
    'status'?: ProxyCreateSchemaStatusEnum;
    'storageId': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ProxyCreateSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "storageId",
    ...
    static getAttributeTypeMap() {
        return ProxyCreateSchema.attributeTypeMap;
    }
...
export enum ProxyCreateSchemaStatusEnum {
    Open = 'OPEN',
    Growing = 'GROWING',
    Awaited = 'AWAITED',
    Closed = 'CLOSED',
