...
export class SegmentElasticSchema {
    'assetId'?: string;
    'dateCreated'?: Date;
    'dateModified'?: Date;
    ...
    'segmentType': SegmentElasticSchemaSegmentTypeEnum;
    'shareUserEmail'?: string | null;
    'status'?: SegmentElasticSchemaStatusEnum;
    'subclipId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "SegmentElasticSchemaSegmentTypeEnum",
            "format": ""
        },
        {
            "name": "shareUserEmail",
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "SegmentElasticSchemaStatusEnum",
            "format": ""
        },
        {
            "name": "subclipId",
    ...
    static getAttributeTypeMap() {
        return SegmentElasticSchema.attributeTypeMap;
    }
...
export enum SegmentElasticSchemaSegmentTypeEnum {
    Marker = 'MARKER',
    Qc = 'QC',
    Generic = 'GENERIC',
    Comment = 'COMMENT',
...
export enum SegmentElasticSchemaStatusEnum {
    Active = 'ACTIVE',
    Deleted = 'DELETED'
}
